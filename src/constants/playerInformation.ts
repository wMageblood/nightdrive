export const PLAYER_INFORMATION = [
  ...
  { rank: "No me tiro personales Damba", name: "Damba", description: "", mainClass: "warlock" },
  ...
  { rank: "Gay (juega paladin)", name: "Fenrus", description: "", mainClass: "shaman" },
  { rank: "Ms Ale", name: "Galilea", description: "", mainClass: "paladin" },
  ...
  { rank: "Ignora a Kayn y a Kreic cuando le pide el cristal", name: "🫏", description: "", mainClass: "shaman" },
];